...
data["ValentinesdayCata"] = {
    ...
    items = { {                                                                       -- Valentineday
        ...
        [NORMAL_DIFF] = { { 1, 238335 },                                              -- Winking Eye of Love
            { 2,  238334 },                                                           -- Heartbreak Charm
            { 3,  238338 },                                                           -- Shard of Pirouetting Happiness
            { 4,  238336 },                                                           -- Sweet Perfume Broach
            { 5,  238337 },                                                           -- Choker of the Pure Heart
